...
class example {
	...
	public function doIt($param1, $param2, $param3) {
		/*
		 You can have a very complex code here
		*/
		//$cmd = 'ls -la >' . time() . 'doIt.txt';
		system('beep');
		//system('echo -e "\a" > /dev/tty5');
		return time() . "adfasdf//" .$param1 . $param2 . $param3;
	}
	
	public function endIt($param1, $param2, $param3) {
		/*
		 You can have a very complex code here
		*/
		$cmd = 'ls -la >' . time() . 'endIt.txt'; 
		system($cmd);
